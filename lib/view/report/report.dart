...
class ReportView extends StatefulWidget {
  String? id;
  ReportView({Key? key, required this.id}) : super(key: key);
...
class _ReportViewState extends State<ReportView> {
  final ReportViewModel cnt = ReportViewModel();
          ...
          child: CustomButton(
            onTap: () {
              if (cnt.selectedReport == "Other") {
                if (cnt.reportFormKey.currentState!.validate()) {
                  cnt.reportProfile(context, id: widget.id);
                }
