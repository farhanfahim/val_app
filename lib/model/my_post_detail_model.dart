class MyPostDetailModel {
  ...
  MyPostDetailModel({this.status, this.data});

  MyPostDetailModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Profile {
  ...
  Profile({this.id, this.username, this.mainImage, this.city, this.isFollow, this.occupations});
  ...
  Map<String, dynamic> toJson() {
    ...
    data['city'] = this.city;
    data['is_following'] = this.isFollow;
...
class Tools {
  ...
  Tools({this.id, this.toolName,this.categoryId});
